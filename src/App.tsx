...
function App() {
  return (
    <div className="flex flex-col w-full min-h-screen">
      <section className="container mx-auto py-2 w-full">
      ...
      {/* seção iphone */}
      <section className="flex flex-col lg:flex-row items-center justify-around w-full container mx-auto py-4 md:py-12 flex-1">
